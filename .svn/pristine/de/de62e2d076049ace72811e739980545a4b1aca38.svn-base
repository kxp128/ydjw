$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
			...
			{ label: '配偶姓名', name: 'spouseName', index: 'spouse_name', width: 80 },
			{ label: '结婚时间', name: function (obj) {
				return obj.marriedTime==null?null:obj.marriedTime.substring(0,11);
