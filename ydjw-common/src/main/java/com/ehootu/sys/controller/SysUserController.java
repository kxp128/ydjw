...
import com.ehootu.core.validator.Assert;
import com.ehootu.core.validator.ValidatorUtils;
import com.ehootu.core.validator.group.AddGroup;
import com.ehootu.core.validator.group.UpdateGroup;
...
public class SysUserController extends AbstractController {
	...
	public R password(String password, String newPassword){
		...
		//sha256加密
		password = ApplicationUtils.md5(password);
		//sha256加密
		newPassword = ApplicationUtils.md5(password);
